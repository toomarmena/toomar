...
export function Hero({ featured, lang, d }: { featured: SeriesSummary | null; lang: Lang; d: Dict }) {
  ...
  const cover = (
    <div className="absolute left-[-46px] top-4 w-[150px] md:left-[-40px] md:top-10 md:w-[380px] rotate-[-7deg] md:rotate-[-5deg] frame bg-coral shadow-[6px_6px_0_#111111] md:shadow-[10px_10px_0_#111111] cover-2-3">
      {featured?.coverUrl ? (
  ...
  return (
    <section className="relative overflow-hidden border-b-2 border-ink px-[18px] pt-[26px] pb-[22px] md:px-16 md:pt-16 md:pb-14">
      {featured ? (
      ...
      <div className="relative flex flex-col gap-3 md:gap-[22px] max-w-[250px] md:max-w-[900px] md:ps-0 md:pe-0 md:ml-[340px] lg:ml-0">
        ...
        <div className="flex flex-wrap items-center gap-4 md:gap-[22px] pt-1 md:pt-2.5">
